...
- `generated/` - Directory containing generated files (auto-created by capture script):
  - `wave_sim.wgf` - Serialized CUDA graph (Warp Graph File)
...
This creates `wave_sim.wgf` containing 17 kernel launches (1 displace + 16 solve).
...
APICGraph graph = wp_apic_load_graph(context, "generated/wave_sim");
