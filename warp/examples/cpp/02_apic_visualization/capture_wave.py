...
CUDA graph using Warp's APIC mode. The resulting .wgf file can be loaded and executed
...
Output:
    generated/wave_sim.wgf          - Serialized CUDA graph
...
def capture_wave_graph(
    ...
    Args:
        ...
        output_path: Output path for .wgf file (without extension)
    """
    ...
    print(f"\nSaved graph to {output_path}.wgf")
